...
//            googleMap.moveCamera(CameraUpdateFactory.newLatLng(coordinate));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SlidingUpPanelLayout panelLayout = findViewById(R.id.sliding_layout);
        ...
        SlidingUpPanelLayout.PanelSlideListener listener = new SlidingUpPanelLayout.PanelSlideListener() {
            ...
            public void onPanelStateChanged(View panel, SlidingUpPanelLayout.PanelState previousState, SlidingUpPanelLayout.PanelState newState) {
                Toast.makeText(WeatherDetailsActivity.this, "The state is => " + newState.name(), Toast.LENGTH_SHORT).show();
            }
        };
